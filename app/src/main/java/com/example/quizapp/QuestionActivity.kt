...
class QuestionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submit.setOnClickListener {
            if(selecedOption!=0)
            {
                ...
                {
                   setColor(selecedOption,R.mipmap.wrong_question_option)
                }else{
                    score++;
                }
                setColor(question.correct_ans,R.mipmap.correct_question_option)
    ...
    fun setOptionStyle(){
        ...
        for(op in optionList)
        {
            ...
            op.background=ContextCompat.getDrawable(this,R.mipmap.question_option)
    ...
    fun selectedOptionStyle(view:TextView,opt:Int){
        ...
        setOptionStyle()
        selecedOption=opt
        view.background=ContextCompat.getDrawable(this,R.mipmap.selected_question_option)
